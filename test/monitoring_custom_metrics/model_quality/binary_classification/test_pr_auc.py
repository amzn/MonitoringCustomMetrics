...
from src.monitoring_custom_metrics.model_quality.binary_classification.pr_auc import (
    instance,
)
...
CONFIG = {"metric_name": "pr_auc"}

CONFIG_OVERRIDE = {"metric_name": "pr_auc", "threshold_override": 0.05}

EXPECTED_STATISTIC = {"value": 0.7794, "standard_deviation": 0}
EXPECTED_VIOLATION = {
    "constraint_check_type": "LessThanThreshold",
    "description": "Metric pr_auc with 0.7794 was LessThanThreshold 0.8294",
    "metric_name": "pr_auc",
}
