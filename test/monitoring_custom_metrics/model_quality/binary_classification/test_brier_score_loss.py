...
from src.monitoring_custom_metrics.model_quality.binary_classification.brier_score_loss import (
    instance,
)
...
CONFIG = {"metric_name": "brier_score_loss"}

CONFIG_OVERRIDE = {"metric_name": "brier_score_loss", "threshold_override": -0.05}

EXPECTED_STATISTIC = {"value": 0.1719, "standard_deviation": 0}
EXPECTED_VIOLATION = {
    "constraint_check_type": "GreaterThanThreshold",
    "description": "Metric brier_score_loss with 0.1719 was GreaterThanThreshold 0.1219",
